...
For regular verbs, Past Simple ends in `-ed`; for irregular verbs, the Past Simple doesn't end in `-ed`.
...
# In question and negative sentences we use did/didn't + infinitive(enjoy/see/go):
