...
### 5.2 For regular verbs, Past Simple ends in -ed; for irregular verbs, the Past Simple doesn't end in -ed.
...
- go -> went: I went to the cenima three times last week.
    
- shut -> shut: It was cold, so I shut the window.
    

### 5.3 In question and negative sentences we use did/didn't + infinitive(enjoy/see/go):
...
### 5.4 the past of be(am/is/are) is was/were
