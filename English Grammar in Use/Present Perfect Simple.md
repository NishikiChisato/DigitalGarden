...
Yet means until now. We use yet to show that we are expecting something to happen.
We can use yet in questions and negative sentences:
...
- The weather is bad here. It's rained every day since I arrived. -> from when I arrived until now.
...
- I've drunk four cups of coffee today. -> today isn't finished when I say.
- Have you had a holiday this year? -> this year isn't finished at the time of speaking.
- I haven't seen Tom this morning. Have you? -> the same as above.
...
- Ben isn't here. He's gone out. -> He went out.
- 'Are you hungry?' 'No, I've just had lunch.' -> 'No, I just had lunch.'

Present perfect simple itself describe a past action that impacts present, therefore we can directly use past simple to describe this past action, but at the expense of losing the connection to the present.